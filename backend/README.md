...
```bash
go install github.com/DonJulve/Hackaton_Cyber_Arena_UCM/backend/cmd/cve-search@latest
```

O compila desde el código fuente:

```bash
git clone https://github.com/DonJulve/Hackaton_Cyber_Arena_UCM.git
cd Hackaton_Cyber_Arena_UCM/backend
